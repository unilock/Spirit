...
public class SpiritMisc {
    ...
    public static final Supplier<RecipeType<SoulEngulfingRecipe>> SOUL_ENGULFING_RECIPE = REGISTRY.registerRecipeType("soul_engulfing", () -> CodecRecipeType.of("soul_engulfing"));
    ...
    public static final Supplier<RecipeType<Tier>> TIER_RECIPE = REGISTRY.registerRecipeType("soul_cage_tier", () -> CodecRecipeType.of("soul_cage_tier"));
    ...
    public static final Supplier<RecipeType<MobTraitData>> MOB_TRAIT = REGISTRY.registerRecipeType("mob_trait", () -> CodecRecipeType.of("mob_trait"));
    ...
    public static final Supplier<RecipeType<PedestalRecipe>> SOUL_TRANSMUTATION_RECIPE = REGISTRY.registerRecipeType("soul_transmutation", () -> CodecRecipeType.of("soul_transmutation"));
